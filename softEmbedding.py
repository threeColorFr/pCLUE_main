...
class SoftEmbedding(nn.Module):
    def __init__(self, 
        ...
        #torch.save(self.learned_embedding, 'embedding.pt')
...
class MultiSoftEmbedding(nn.Module):
    ...
    def initialize_embedding(self, 
        ...
        #return torch.FloatTensor(num_tasks, n_tokens, 512).uniform_(-random_range, random_range) 
    ...
    def forward(self, tokens, types=None):
        ...
        #learned_embedding = self.linear(self.dropout(self.learned_embedding[types])) # (B, ntokens, D)
        return torch.cat([learned_embedding, input_embedding], 1)